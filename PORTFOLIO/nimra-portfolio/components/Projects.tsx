    ...
    <section id="projects" className="px-6 md:px-16 py-28 border-t border-stitch">
      <div className="flex items-end justify-between mb-14 flex-wrap gap-4">
        ...
        <p className="font-mono text-xs text-muted max-w-xs">
          Pulled live from Supabase — add a row, it shows up here.
        </p>
      </div>

      {projects.length === 0 ? (
        <div className="spec-corner border border-stitch p-10 text-center">
          <p className="font-mono text-sm text-muted">
            No projects yet. Add rows to the{" "}
            <span className="text-teal">projects</span> table in Supabase to
